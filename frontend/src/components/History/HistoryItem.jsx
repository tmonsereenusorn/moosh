    ...
    >
      ...
      <Popover position="right">
        <Popover.Trigger>
          {active && (
            <BsThreeDots
              className="relative z-30 scale-200 hover:text-primary hover:cursor-pointer text-surface"
            />
          )}
        </Popover.Trigger>
        <Popover.Content>
          <div className="rounded-md p-1 hover:cursor-pointer hover:bg-gray-200 flex space-x-2" onClick={e => action(e, onDelete)}>
            <MdDelete />
