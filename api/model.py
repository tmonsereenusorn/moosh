        ...
        "function": {
            ...
            "parameters": {
                ...
                "properties": {
                    ...
                    "seed_genres": {
                        "type": "string",
                        "description": "A comma separated list of EXACTLY two genres (i.e. acoustic, black-metal). You MUST return two seed genres and they MUST be in the enum list. SUPER IMPORTANT.",
                        "enum": [
                                    "acoustic",
                                    "afrobeat",
                                    "alt-rock",
